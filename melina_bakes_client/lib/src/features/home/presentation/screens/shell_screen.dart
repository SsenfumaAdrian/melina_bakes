...
/// Shell screen that provides persistent navigation.
///
/// Displays a [NavigationBar] on mobile, [NavigationRail] on tablet/desktop,
/// and adapts the layout based on screen size and user role.
library;
...
class _ShellScreenState extends ConsumerState<ShellScreen> {
  int _getSelectedIndex(String location) {
    if (widget.isAdmin) {
      return _adminRoutes.indexWhere((r) => location.startsWith(r.path));
    }
  ...
  Widget build(BuildContext context) {
    ...
    final isAdminUser = user?.role.isStaffOrAbove ?? false;
...
const List<_NavRoute> _adminRoutes = [
  ...
  _NavRoute(
    path: RouteNames.adminInventory,
    label: 'Inventory',
